...
static const int64 DUST_SOFT_LIMIT = 100000; // 0.001 FAT
/** Dust Hard Limit, ignored as wallet inputs (mininput default) */
static const int64 DUST_HARD_LIMIT = 1000;   // 0.00001 FAT mininput
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        return dPriority > COIN * 5760 / 250;  // Fatcoin: 5760 blocks found a day. Priority cutoff is 1 fatcoin day / 250 bytes.
    }
